...
const Bipolar = () => {
      ...
      <div class='relative w-3/5 mx-auto mt-32'>
        ...
        <section id="Bipolar" className="pt-14 px-8 pb-28">
                ...
                <div className="pt-14 px-8 md:px-28 flex flex-wrap justify-center items-center gap-4">
                    <Link to="/Bipolar" className="px-2 w-auto">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        Gangguan Bipolar: Memahami Gejala dan Pilihan pengobatan
                    </div>
    ...
    <h3 class="text- font-bold mb-2">Gejala Gangguan Bipolar</h3>
    

    <h3 class="text-justify font-bold mb-2">Episode Manik:</h3>
    ...
    <h3 class="text-justify font-bold mb-2">Pilihan Pengobatan</h3>
    

    
    <ul class="list-disc ml-6 text-justify mb-4">
