        ...
        <div className="max-w-xl w-full space-y-5 border-2 p-10 rounded-lg bg-white">
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              Tidak punya akun? <Link to="/Daftar " className="font-medium text-[#008DDA] hover:text-[#1572A1]">Daftar</Link>
            </div>
...
//         <div>
//           <img src={iconlogin} alt="" className="w-full h-full object-cover"/>
//           <h1 className='text-center font-bold text-2xl text-[#008DDA] my-4'>Masuk sebagai Terapis</h1>
//         </div>
//       </div>
//       <div className='w-1/2 h-full bg-[#1572A1] flex flex-col mt-20 ml-5'>
//       </div>
//     </div>
//   )
// }
