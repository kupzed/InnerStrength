...
import hatiwarasrhead from "../assets/hatiwarashead.png";
...
const hatiwarasr = () => {
    return (
      ...
      <div className='px-28 pt-28 mt-9 pd-8'>
        <img src={hatiwarasrhead} className="object-center mx-auto" /> 
        </div>
       
       <section id="IsiKomunitas" class="pt-14 px-48 pb-28 text-center">
        <div class=" justify-center">
            <div class="flex flex-wrap justify-center">
                <div class="pr-12 pb-12 text-5xl  font-extrabold text-[#1572A1] ">Hati Waras</div>
