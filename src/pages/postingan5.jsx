...
import postingan5head from "../assets/postingan5head.png";
...
const Postingan1 = () => {
                ...
                <div className="container mx-auto">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className='w-10/12'>
                            <img src={postingan5head} className="object-center mx-auto pb-14" alt="Postingan 1 Header" />
                        </div>
                    </div>

                    <div className="text-3xl font-bold text-black text-center pb-14">
                    Terapi Perilaku Kognitif (CBT): Menemukan Harapan Baru dalam Melawan Depresi
                    </div>
    ...
    <div class="max-w- bg-white p-8 rounded-lg shadow-lg space-y-12 text-justify">
      <h2 class="text-3xl font-bold"></h2>

      <p class="text-lg leading-relaxed">
        Terapi Perilaku Kognitif (Cognitive Behavioral Therapy/CBT) telah terbukti sebagai pendekatan yang efektif dalam mengatasi depresi. Dalam CBT, fokus diberikan pada hubungan antara pikiran, emosi, dan perilaku seseorang. Tujuan utamanya adalah untuk mengubah pola pikir negatif yang dapat memperburuk depresi menjadi pola pikir yang lebih positif dan sehat.
      </p>

      <h3 class="text-2xl font-bold">Prinsip Dasar CBT dalam Mengelola Depresi:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Identifikasi Pola Pikir Negatif: Terapis CBT akan membantu individu mengidentifikasi pola pikir negatif yang mungkin menyebabkan atau memperburuk depresi.</li>
        <li class="text-lg">Refleksi dan Pengenalan Emosi: Proses ini melibatkan refleksi terhadap emosi yang muncul sebagai respons terhadap pikiran-pikiran tertentu.</li>
        <li class="text-lg">Pengembangan Strategi Kognitif: Individu akan mempelajari teknik-teknik kognitif untuk mengubah pola pikir negatif menjadi pola pikir yang lebih positif dan adaptif.</li>
        <li class="text-lg">Perubahan Perilaku: Selain mengubah pola pikir, CBT juga mendorong individu untuk mengubah perilaku yang mungkin memperburuk depresi, seperti isolasi sosial atau aktivitas yang tidak sehat.</li>
      </ul>

      <h3 class="text-2xl font-bold">Manfaat CBT dalam Mengatasi Depresi:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Memahami Keterkaitan Pikiran dan Emosi: CBT membantu individu memahami bagaimana pikiran mereka mempengaruhi perasaan dan tindakan mereka.</li>
        <li class="text-lg">Mengelola Gejala Depresi: Dengan mengidentifikasi dan mengubah pola pikir negatif, individu dapat mengurangi intensitas dan frekuensi gejala depresi.</li>
        <li class="text-lg">Meningkatkan Keterampilan Mengatasi Krisis: CBT memberikan keterampilan coping yang dapat digunakan individu dalam menghadapi situasi krisis atau stres.</li>
        <li class="text-lg">Peningkatan Kualitas Hidup: Dengan mereduksi gejala depresi, CBT dapat membantu meningkatkan kualitas hidup secara keseluruhan.</li>
      </ul>

      <p class="text-lg leading-relaxed">
        Penting untuk diingat bahwa CBT efektif dalam berbagai tingkat keparahan depresi, namun hasilnya dapat bervariasi antar individu. Konsistensi dalam menjalani sesi terapi dan komitmen untuk menerapkan teknik-teknik yang dipelajari juga menjadi kunci keberhasilan dalam CBT. Jika Anda atau seseorang yang Anda kenal mengalami gejala depresi, konsultasikan dengan profesional kesehatan mental untuk evaluasi dan rekomendasi yang tepat.
      </p>
    </div>
  </div>
