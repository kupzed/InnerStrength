...
import postingan4head from "../assets/postingan4head.png";
...
const Postingan1 = () => {
                ...
                <div className="container mx-auto">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className='w-10/12'>
                            <img src={postingan4head} className="object-center mx-auto pb-14" alt="Postingan 1 Header" />
                        </div>
                    </div>
    ...
    <div class="max-w bg-white p-8 rounded-lg shadow-lg space-y-6 text-justify">
      <h2 class="text-3xl font-bold">Menemukan Kedamaian di Alam Bebas: Hobi Outdoor untuk Melawan Depresi</h2>

      <p class="text-lg leading-relaxed">
        Kehidupan modern sering kali membawa kita pada tingkat stres dan tekanan yang tinggi. Untuk mengatasi tantangan ini, semakin banyak orang mencari solusi dalam bentuk kegiatan di alam bebas yang menyegarkan dan membangkitkan semangat. Aktivitas outdoor tidak hanya memberikan kesempatan untuk menikmati alam, tetapi juga memiliki manfaat yang besar dalam meningkatkan kesehatan mental dan melawan depresi.
      </p>

      <h3 class="text-2xl font-bold">Keuntungan Hobi Outdoor dalam Menangani Depresi:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Kontak dengan Alam: Menghabiskan waktu di alam dapat mengurangi tingkat stres dan meningkatkan suasana hati.</li>
        <li class="text-lg">Aktivitas Fisik: Berbagai kegiatan seperti hiking, bersepeda, atau berenang tidak hanya menyegarkan tubuh tetapi juga merangsang produksi endorfin yang meningkatkan perasaan bahagia.</li>
        <li class="text-lg">Pengalaman Menyenangkan: Menjelajahi tempat-tempat baru dan menantang diri sendiri dengan kegiatan outdoor dapat memberikan rasa pencapaian dan kepuasan.</li>
        <li class="text-lg">Kesempatan untuk Refleksi: Alam memberikan suasana yang tenang dan terapeutik yang mendukung refleksi diri dan kesejahteraan mental secara keseluruhan.</li>
      </ul>

      <h3 class="text-2xl font-bold">Aktivitas Outdoor yang Menenangkan:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Hiking: Menjelajahi pegunungan atau hutan dengan jalur hiking yang menantang adalah cara yang hebat untuk menghilangkan stres dan menikmati pemandangan alam.</li>
        <li class="text-lg">Bersepeda: Bersepeda di jalur alam atau di sekitar kota tidak hanya menyehatkan tetapi juga menyenangkan.</li>
        <li class="text-lg">Camping: Menghabiskan waktu di luar ruangan dengan berkemah dapat memberikan pengalaman mendalam dengan alam.</li>
        <li class="text-lg">Fotografi Alam: Mengabadikan keindahan alam dengan fotografi dapat menjadi hobi yang memuaskan dan memberikan kesempatan untuk mengekspresikan kreativitas.</li>
      </ul>

      <p class="text-lg leading-relaxed">
        Melibatkan diri dalam hobi outdoor bukan hanya tentang rekreasi fisik, tetapi juga tentang membangun koneksi dengan alam dan memperkaya kehidupan secara keseluruhan. Aktivitas ini dapat menjadi bagian penting dalam strategi perawatan diri untuk mengatasi depresi, namun tidak menggantikan bantuan profesional jika diperlukan. Dengan mengintegrasikan kegiatan outdoor ke dalam rutinitas harian, seseorang dapat menemukan kedamaian dan keseimbangan dalam kehidupan mereka.
      </p>
    </div>
  </div>
