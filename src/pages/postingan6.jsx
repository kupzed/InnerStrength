...
import postingan6head from "../assets/postingan6head.png";
...
const Postingan1 = () => {
                ...
                <div className="container mx-auto">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className='w-10/12'>
                            <img src={postingan6head} className="object-center mx-auto pb-14" alt="Postingan 1 Header" />
                        </div>
                    </div>
    ...
    <div class="max-w- bg-white p-8 rounded-lg shadow-lg space-y-6 text-justify">
      <h2 class="text-3xl font-bold">Terapi Interpersonal (IPT): Membangun Hubungan yang Sehat untuk Melawan Depresi</h2>

      <p class="text-lg leading-relaxed">
        Terapi Interpersonal (IPT) adalah pendekatan terapeutik yang fokus pada hubungan interpersonal individu sebagai faktor yang mempengaruhi kesehatan mental. IPT bertujuan untuk membantu individu memahami pola hubungan mereka dan memperbaiki kualitas interaksi dengan orang lain sebagai strategi untuk mengatasi depresi.
      </p>

      <h3 class="text-2xl font-bold">Prinsip Dasar IPT dalam Mengelola Depresi:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Identifikasi Pola Hubungan yang Negatif: Terapis IPT bekerja sama dengan individu untuk mengidentifikasi pola hubungan yang mungkin memperburuk gejala depresi.</li>
        <li class="text-lg">Fokus pada Hubungan Saat Ini: IPT mengarahkan perhatian pada dinamika hubungan saat ini daripada pada sejarah hidup atau masalah internal individu.</li>
        <li class="text-lg">Peningkatan Keterampilan Komunikasi: Terapis membantu individu mengembangkan keterampilan komunikasi yang lebih efektif dan membangun hubungan yang lebih memuaskan.</li>
        <li class="text-lg">Penguatan Dukungan Sosial: IPT mengupayakan untuk meningkatkan dukungan sosial yang positif sebagai cara untuk mengurangi isolasi sosial dan meningkatkan kesejahteraan emosional.</li>
      </ul>

      <h3 class="text-2xl font-bold">Manfaat IPT dalam Mengatasi Depresi:</h3>
      <ul class="list-disc ml-6 space-y-2">
        <li class="text-lg">Pemahaman yang Lebih Baik tentang Hubungan: IPT membantu individu memahami bagaimana interaksi sosial mereka mempengaruhi kesehatan mental.</li>
        <li class="text-lg">Pengurangan Gejala Depresi: Dengan memperbaiki hubungan interpersonal, individu dapat mengurangi gejala depresi seperti perasaan kesepian atau tidak berharga.</li>
        <li class="text-lg">Meningkatkan Dukungan dan Koneksi: IPT membantu individu merasa lebih didukung dan terhubung dengan orang-orang di sekitarnya, yang penting untuk kesehatan mental yang baik.</li>
        <li class="text-lg">Mendorong Perubahan Positif dalam Kualitas Hidup: Dengan membangun hubungan yang sehat, IPT dapat membantu meningkatkan kualitas hidup secara keseluruhan.</li>
      </ul>

      <p class="text-lg leading-relaxed">
        Penting untuk dicatat bahwa IPT adalah pendekatan yang berfokus pada aspek interpersonal dari depresi dan dapat efektif dalam meningkatkan kesehatan mental individu. Namun demikian, setiap perawatan harus disesuaikan dengan kebutuhan individu dan mungkin memerlukan kombinasi dengan terapi lain atau intervensi medis. Jika Anda atau seseorang yang Anda kenal mengalami gejala depresi, konsultasikan dengan profesional kesehatan mental untuk evaluasi dan rekomendasi yang tepat.
      </p>
    </div>
  </div>
