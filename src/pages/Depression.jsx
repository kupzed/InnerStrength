...
import depressionhead from "../assets/depressionhead.png";
...
const Bipolar = () => {
    return (
      ...
      <div className='px-28 pt-28 mt-9 pd-8'>
        <img src={depressionhead} className="object-center mx-auto" /> 
        </div>
        ...
        <div class="container">
            ...
            <div class="flex flex-wrap">
                <div class="w-3/5 px-4">
                    ...
                    <p class="text-base text-justify mb-4 pt-4">
    ...
    <h3 class="text-lg font-bold mb-2">Tanda dan Gejala Depresi</h3>
                ...
                <div class=" px-12 w-2/5">
                    ...
                    <Link to="/Rekomen9">
                            <div class="flex flex-wrap py-4">
                             ...
                             <img src={depression1} class="w-36 h-36"/>
                           
                             <div class="text-base  ml-2 w-8/12">Depresi sering menjadi bahan bercandaan kita. Namun, apakah kalian sudah tahu, sebenarnya apa yang dimaksud dengan depresi?</div>
                            </div>
                        </Link>
                        
                        <Link to="/Rekomen10">
                        <div class="flex flex-wrap py-4">
                            <img src={depression2} class="w-36 h-36"/>
                            
                            <div class="text-base ml-2 w-8/12">Depresi Dan Hipomania</div>
                        </div>
                        </Link>
                        ...
                        <Link to="/Rekomen11">
                        <div class="flex flex-wrap py-4">
                            <img src={depression3} class="w-36 h-36"/>
                            
                            <div class="text-base  ml-2 w-8/12">Apa Itu Depresi?</div>
                        </div>
                        </Link>

                        <Link to="/Rekomen12">
                        <div class="flex flex-wrap py-4">
                            <img src={depression4} class="w-36 h-36"/>
                            
                            <div class="text-base  ml-2 w-8/12">Depresi = Sedih? Tidak!
                            </div>
                        </div>
                        </Link>
